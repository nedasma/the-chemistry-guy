...
namespace Chemija {
	...
	namespace {
		Klase Kl3; // klasės objektas
	};
	/// <summary>
	/// Summary for Molmase3var
	/// </summary>
	public ref class Molmase3var : public System::Windows::Forms::Form
	{
	public:
		Molmase3var(void)
		{
...
#pragma region Windows Form Designer generated code
		...
		void InitializeComponent(void)
		{
			...
			this->groupBox1->Size = System::Drawing::Size(291, 580);
			...
			this->button1->Click += gcnew System::EventHandler(this, &Molmase3var::button1_Click);
			// 
			// textBox10
			// 
			...
			// textBox3
			// 
			this->textBox3->Location = System::Drawing::Point(121, 185);
			...
			// textBox1
			// 
			this->textBox1->Location = System::Drawing::Point(121, 66);
			...
			this->label8->Location = System::Drawing::Point(1, 301);
			...
			this->label7->Location = System::Drawing::Point(1, 275);
			...
			this->label6->Size = System::Drawing::Size(304, 27);
			this->label6->TabIndex = 5;
			this->label6->Text = L"3. Kokį tūrį užims n.s. ir kiek svers 9,444 x 10²³ fluoro (F₂) molekulių\?";
			// 
			// label5
			// 
			this->label5->AutoSize = true;
			this->label5->Location = System::Drawing::Point(1, 192);
			...
			this->label4->Size = System::Drawing::Size(295, 33);
			this->label4->TabIndex = 3;
			this->label4->Text = L"2. Kokia yra 2,45 x 10²³ sieros rūgšties (H₂SO₄) molekulių masė\? ";
			// 
			// label3
			// 
			this->label3->AutoSize = true;
			this->label3->Location = System::Drawing::Point(1, 101);
			...
			this->label2->Location = System::Drawing::Point(1, 69);
			...
			this->label1->Location = System::Drawing::Point(42, 32);
			this->label1->Name = L"label1";
			this->label1->Size = System::Drawing::Size(224, 13);
			this->label1->TabIndex = 0;
			this->label1->Text = L"1. Kiek molių ir molekulių yra 0,8 g deguonies\?";
			// 
			// menuStrip1
			// 
			...
			this->periodinėCheminiųElementųLentelėToolStripMenuItem->Click += gcnew System::EventHandler(this, &Molmase3var::periodinėCheminiųElementųLentelėToolStripMenuItem_Click);
			// 
			// label14
			// 
			this->label14->AutoSize = true;
			this->label14->Location = System::Drawing::Point(16, 536);
			...
			this->label15->Location = System::Drawing::Point(201, 536);
			...
			this->ClientSize = System::Drawing::Size(316, 604);
			this->Controls->Add(this->menuStrip1);
			this->Controls->Add(this->groupBox1);
			this->Name = L"Molmase3var";
			this->StartPosition = System::Windows::Forms::FormStartPosition::CenterScreen;
			this->Text = L"3 variantas";
			this->Load += gcnew System::EventHandler(this, &Molmase3var::Molmase3var_Load);
...
#pragma endregion
	private: System::Void Molmase3var_Load(System::Object^  sender, System::EventArgs^  e) {
			label9->Hide();
			label10->Hide();
			label11->Hide();
			label12->Hide();
	...
	private: System::Void button1_Click(System::Object^  sender, System::EventArgs^  e) {
			...
			ats11 = Kl3.Mol(Kl3.A, Kl3.n, 0.8, "O", 0, 0, "", 0);
			ats12 = Kl3.Molsk(ats11) / pow(10, 23);
			mol = Kl3.Mol(Kl3.A, Kl3.n, 0, "", 0, 0, "", 2.45 * pow(10, 23));
			ats2 = Kl3.Molinemase(Kl3.D, Kl3.A, Kl3.n, Kl3.l, mol, "HSO4");
			mol = 0;
			mol = Kl3.Mol(Kl3.A, Kl3.n, 0, "", 0, 0, "", 9.444 * pow(10, 23));
			ats31 = Kl3.Turis(Kl3.A, Kl3.n, mol, "F", 0);
			ats32 = Kl3.Molinemase(0, Kl3.A, Kl3.n, 0, mol, "F2");
