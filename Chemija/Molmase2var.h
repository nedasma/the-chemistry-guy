...
namespace Chemija {
	...
	namespace {
		Klase Kl2; // klasės objektas
	};
	/// <summary>
	/// Summary for Molmase2var
	/// </summary>
	public ref class Molmase2var : public System::Windows::Forms::Form
	{
	public:
		Molmase2var(void)
		{
...
#pragma region Windows Form Designer generated code
		...
		void InitializeComponent(void)
		{
			...
			this->groupBox1->Size = System::Drawing::Size(291, 578);
			...
			this->button1->Click += gcnew System::EventHandler(this, &Molmase2var::button1_Click);
			// 
			// textBox10
			// 
			...
			this->label8->Location = System::Drawing::Point(10, 301);
			...
			this->label7->Location = System::Drawing::Point(10, 275);
			...
			// label6
			// 
			this->label6->Location = System::Drawing::Point(6, 231);
			this->label6->Name = L"label6";
			this->label6->Size = System::Drawing::Size(285, 27);
			this->label6->TabIndex = 5;
			this->label6->Text = L"3. Kokį tūrį užims n.s. ir kiek svers 2,245 x 10²³ azoto (N₂) molekulių\?";
			// 
			// label5
			// 
			this->label5->AutoSize = true;
			this->label5->Location = System::Drawing::Point(6, 192);
			...
			this->label4->Size = System::Drawing::Size(289, 13);
			this->label4->TabIndex = 3;
			this->label4->Text = L"2. Kokia yra 5,33 x 10²³ bario sulfato (BaS) molekulių masė\? ";
			// 
			// label3
			// 
			this->label3->AutoSize = true;
			this->label3->Location = System::Drawing::Point(1, 105);
			...
			this->label1->Text = L"1. Kiek molių ir molekulių yra 24 g magnio\?";
			// 
			// menuStrip1
			// 
			...
			this->periodinėCheminiųElementųLentelėToolStripMenuItem->Click += gcnew System::EventHandler(this, &Molmase2var::periodinėCheminiųElementųLentelėToolStripMenuItem_Click);
			// 
			// label14
			// 
			this->label14->AutoSize = true;
			this->label14->Location = System::Drawing::Point(10, 535);
			...
			this->label15->Location = System::Drawing::Point(189, 535);
			...
			this->ClientSize = System::Drawing::Size(320, 595);
			this->Controls->Add(this->menuStrip1);
			this->Controls->Add(this->groupBox1);
			this->Name = L"Molmase2var";
			this->StartPosition = System::Windows::Forms::FormStartPosition::CenterScreen;
			this->Text = L"2 variantas";
			this->Load += gcnew System::EventHandler(this, &Molmase2var::Molmase2var_Load);
...
#pragma endregion
	private: System::Void Molmase2var_Load(System::Object^  sender, System::EventArgs^  e) {
				label9->Hide();
				label10->Hide();
				label11->Hide();
				label12->Hide();
	...
	private: System::Void button1_Click(System::Object^  sender, System::EventArgs^  e) {
				...
				ats11 = Kl2.Mol(Kl2.A, Kl2.n, 24, "Mg", 0, 0, "", 0);
				ats12 = Kl2.Molsk(ats11) / pow(10, 23);
				mol = Kl2.Mol(Kl2.A, Kl2.n, 0, "", 0, 0, "", 5.33 * pow(10, 23));
				ats2 = Kl2.Molinemase(Kl2.D, Kl2.A, Kl2.n, Kl2.l, mol, "BaS");
				mol = 0;
				mol = Kl2.Mol(Kl2.A, Kl2.n, 0, "", 0, 0, "", 2.245* pow(10, 23));
				ats31 = Kl2.Turis(Kl2.A, Kl2.n, mol, "N", 0);
				ats32 = Kl2.Molinemase(0, Kl2.A, Kl2.n, 0, mol, "N2");
