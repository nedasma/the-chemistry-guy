...
namespace Chemija {
	...
	namespace {
		Klase K9; // klasės objektas
	};
	/// <summary>
	/// Summary for Masesdalis3var
	/// </summary>
	public ref class Masesdalis3var : public System::Windows::Forms::Form
	{
	public:
		Masesdalis3var(void)
		{
...
#pragma region Windows Form Designer generated code
		...
		void InitializeComponent(void)
		{
			...
			this->groupBox1->Location = System::Drawing::Point(0, 11);
			this->groupBox1->Name = L"groupBox1";
			this->groupBox1->Size = System::Drawing::Size(357, 547);
			...
			this->label13->Location = System::Drawing::Point(229, 490);
			...
			this->label12->Location = System::Drawing::Point(41, 490);
			...
			this->button1->Click += gcnew System::EventHandler(this, &Masesdalis3var::button1_Click);
			// 
			// textBox8
			// 
			...
			this->label6->Size = System::Drawing::Size(329, 27);
			this->label6->TabIndex = 5;
			this->label6->Text = L"3. Kuriame junginyje, geležies (II) okside  (FeO)  ar geležies (III) okside  (Fe₂" 
				L"O₃), geležies masės dalis didesnė\? \r\n";
			// 
			// label5
			// 
			...
			this->label4->Text = L"2. Raskite vario masės dalį vario (I) hidrokside (CuOH).\r\n";
			// 
			// label2
			// 
			...
			this->label1->Text = L"1. Apskaičiuokite anglies ir deguonies masės dalis anglies diokside CO₂.";
			// 
			// menuStrip1
			// 
			...
			this->periodinėCheminiųElementųLentelėToolStripMenuItem->Click += gcnew System::EventHandler(this, &Masesdalis3var::periodinėCheminiųElementųLentelėToolStripMenuItem_Click);
			// 
			// Masesdalis3var
			// 
			this->AutoScaleDimensions = System::Drawing::SizeF(6, 13);
			this->AutoScaleMode = System::Windows::Forms::AutoScaleMode::Font;
			this->ClientSize = System::Drawing::Size(357, 561);
			this->Controls->Add(this->menuStrip1);
			this->Controls->Add(this->groupBox1);
			this->Name = L"Masesdalis3var";
			this->StartPosition = System::Windows::Forms::FormStartPosition::CenterScreen;
			this->Text = L"3 variantas";
			this->Load += gcnew System::EventHandler(this, &Masesdalis3var::Masesdalis3var_Load);
...
#pragma endregion
	private: System::Void Masesdalis3var_Load(System::Object^  sender, System::EventArgs^  e) {
				label8->Hide();
				label9->Hide();
				label10->Hide();
				label11->Hide();
	...
	private: System::Void button1_Click(System::Object^  sender, System::EventArgs^  e) {
				 ...
				 K9.Masesdalissk(K9.A, K9.n, "C", 44, w1, w2);
				 ats11 = w1;
				 ats12 = w2;
				 ats2 = K9.Masesdalisjung(K9.A, K9.D, K9.n, K9.l, "CuOH", "Cu");
				 ats2 = Math::Round(ats2, 2); 
			     String^ x3 = gcnew String(ats3.c_str()); 
				 x3 = "FeO";
				 label8->Show();
				 label9->Show();
				 label10->Show();
