...
namespace Chemija {
	...
	namespace {
		Klase K6; // klasës objektas
	};
	/// <summary>
	/// Summary for Koncentracija3var
	/// </summary>
	public ref class Koncentracija3var : public System::Windows::Forms::Form
	{
	public:
		Koncentracija3var(void)
		{
			InitializeComponent();
			//
...
#pragma region Windows Form Designer generated code
		...
		void InitializeComponent(void)
		{
			...
			this->groupBox1->Size = System::Drawing::Size(352, 540);
			...
			this->button1->Click += gcnew System::EventHandler(this, &Koncentracija3var::button1_Click);
			// 
			// textBox8
			// 
			...
			this->label6->Text = L"3. Kiek litrø 0,03 mol/l koncentracijos tirpalo pagaminsime ið 0,42 mol medþiagos" 
				L"\?\r\n";
			// 
			// label5
			// 
			...
			this->label4->Size = System::Drawing::Size(348, 13);
			this->label4->TabIndex = 3;
			this->label4->Text = L"2. Kiek moliø geleþies yra 258 ml tirpalo, kurio koncentracija 0,466 mol/l\?\r\n";
			// 
			// label2
			// 
			...
			this->label1->Text = L"1. 8,4 l tirpalo iðtirpæ 2 mol magnio fosfato. Raskite tirpalo molinæ koncentraci" 
				L"jà.";
			// 
			// menuStrip1
			// 
			...
			this->periodinëCheminiøElementøLentelëToolStripMenuItem->Click += gcnew System::EventHandler(this, &Koncentracija3var::periodinëCheminiøElementøLentelëToolStripMenuItem_Click);
			// 
			// label3
			// 
			...
			this->label8->Location = System::Drawing::Point(231, 493);
			...
			this->Name = L"Koncentracija3var";
			this->StartPosition = System::Windows::Forms::FormStartPosition::CenterScreen;
			this->Text = L"3 variantas";
			this->Load += gcnew System::EventHandler(this, &Koncentracija3var::Koncentracija3var_Load);
...
#pragma endregion
	private: System::Void Koncentracija3var_Load(System::Object^  sender, System::EventArgs^  e) {
				 label9->Hide();
				 label10->Hide();
				 label11->Hide();
				 textBox6->Hide();
	...
	private: System::Void button1_Click(System::Object^  sender, System::EventArgs^  e) {
				 ...
				 ats1 = K6.Molkoncentracija(8.4, 2);
				 ats2 = K6.Koncmol(0.258, 0.466);
				 ats3 = K6.Turis(K6.A, K6.n, 0.42, "", 0.03);
