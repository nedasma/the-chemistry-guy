...
namespace Chemija {
	...
	namespace {
		Klase K4; // klasës objektas
	};
	/// <summary>
	/// Summary for Koncentracija1var
	/// </summary>
	public ref class Koncentracija1var : public System::Windows::Forms::Form
	{
	public:
		Koncentracija1var(void)
		{
			InitializeComponent();
			//
...
#pragma region Windows Form Designer generated code
		...
		void InitializeComponent(void)
		{
			...
			this->groupBox1->Size = System::Drawing::Size(352, 522);
			...
			this->button1->Click += gcnew System::EventHandler(this, &Koncentracija1var::button1_Click);
			// 
			// textBox8
			// 
			...
			this->label6->Text = L"3. Kiek litrø 0,15 mol/l koncentracijos tirpalo pagaminsime ið 0,5 mol medþiagos\?" 
				L"\r\n";
			// 
			// label5
			// 
			...
			this->label4->Size = System::Drawing::Size(336, 13);
			this->label4->TabIndex = 3;
			this->label4->Text = L"2. Kiek moliø cukraus yra 600 ml tirpalo, kurio koncentracija 0,3 mol/l\?\r\n";
			// 
			// label2
			// 
			...
			this->label1->Text = L"1. 2 l tirpalo iðtirpæ 0,2 mol valgomosios druskos. Raskite tirpalo molinæ koncen" 
				L"tracijà.";
			// 
			// menuStrip1
			// 
			...
			this->periodinëCheminiøElementøLentelëToolStripMenuItem->Click += gcnew System::EventHandler(this, &Koncentracija1var::periodinëCheminiøElementøLentelëToolStripMenuItem_Click);
			// 
			// label3
			// 
			this->label3->AutoSize = true;
			this->label3->Location = System::Drawing::Point(43, 484);
			...
			this->label8->Location = System::Drawing::Point(222, 484);
			...
			this->ClientSize = System::Drawing::Size(376, 539);
			this->Controls->Add(this->menuStrip1);
			this->Controls->Add(this->groupBox1);
			this->Name = L"Koncentracija1var";
			this->StartPosition = System::Windows::Forms::FormStartPosition::CenterScreen;
			this->Text = L"1 variantas";
			this->Load += gcnew System::EventHandler(this, &Koncentracija1var::Koncentracija1var_Load);
...
#pragma endregion
	private: System::Void Koncentracija1var_Load(System::Object^  sender, System::EventArgs^  e) {
				 label9->Hide();
				 label10->Hide();
				 label11->Hide();
				 textBox6->Hide();
	...
	private: System::Void button1_Click(System::Object^  sender, System::EventArgs^  e) {
				...
				ats1 = K4.Molkoncentracija(2, 0.2);
				ats2 = K4.Koncmol(0.6, 0.3);
				ats3 = K4.Turis(K4.A, K4.n, 0.5, "", 0.15);
