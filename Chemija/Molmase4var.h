...
namespace Chemija {
	...
	namespace {
		Klase Kl4; // klasës objektas
	};
	/// <summary>
	/// Summary for Molmase4var
	/// </summary>
	public ref class Molmase4var : public System::Windows::Forms::Form
	{
	public:
		Molmase4var(void)
		{
...
#pragma region Windows Form Designer generated code
		...
		void InitializeComponent(void)
		{
			...
			this->groupBox1->Size = System::Drawing::Size(291, 576);
			...
			this->button1->Click += gcnew System::EventHandler(this, &Molmase4var::button1_Click);
			// 
			// textBox10
			// 
			...
			// textBox5
			// 
			this->textBox5->Location = System::Drawing::Point(114, 298);
			...
			// textBox4
			// 
			this->textBox4->Location = System::Drawing::Point(114, 272);
			...
			// textBox2
			// 
			this->textBox2->Location = System::Drawing::Point(114, 98);
			...
			// textBox1
			// 
			this->textBox1->Location = System::Drawing::Point(114, 62);
			...
			this->label6->Text = L"3. Koká tûrá uþims n.s. ir kiek svers 9,562 x 10²³ fosforo (P) molekuliø\?";
			// 
			// label5
			// 
			...
			// label4
			// 
			this->label4->Location = System::Drawing::Point(0, 136);
			this->label4->Name = L"label4";
			this->label4->Size = System::Drawing::Size(302, 31);
			this->label4->TabIndex = 3;
			this->label4->Text = L"2. Kokia yra 7,014 x 10²³ natrio hidroksido (NaOH) molekuliø masë\? ";
			// 
			// label3
			// 
			this->label3->AutoSize = true;
			this->label3->Location = System::Drawing::Point(0, 101);
			this->label3->Name = L"label3";
			this->label3->Size = System::Drawing::Size(113, 13);
			this->label3->TabIndex = 2;
			this->label3->Text = L"Ats. (molekuliø, x 10²³):";
			// 
			// label2
			// 
			...
			this->label1->Text = L"1. Kiek moliø ir molekuliø yra 18,3 g lièio\?";
			// 
			// menuStrip1
			// 
			...
			this->periodinëCheminiøElementøLentelëToolStripMenuItem->Click += gcnew System::EventHandler(this, &Molmase4var::periodinëCheminiøElementøLentelëToolStripMenuItem_Click);
			// 
			// label14
			// 
			this->label14->AutoSize = true;
			this->label14->Location = System::Drawing::Point(15, 536);
			this->label14->Name = L"label14";
			this->label14->Size = System::Drawing::Size(132, 13);
			this->label14->TabIndex = 28;
			this->label14->Text = L"Atsakei teisingai uþduoèiø:";
			// 
			// label15
			// 
			this->label15->AutoSize = true;
			this->label15->Location = System::Drawing::Point(189, 536);
			...
			this->ClientSize = System::Drawing::Size(315, 600);
			this->Controls->Add(this->menuStrip1);
			this->Controls->Add(this->groupBox1);
			this->Name = L"Molmase4var";
			this->StartPosition = System::Windows::Forms::FormStartPosition::CenterScreen;
			this->Text = L"4 variantas";
			this->Load += gcnew System::EventHandler(this, &Molmase4var::Molmase4var_Load);
...
#pragma endregion
	private: System::Void Molmase4var_Load(System::Object^  sender, System::EventArgs^  e) {
			label9->Hide();
			label10->Hide();
			label11->Hide();
			label12->Hide();
	...
	private: System::Void button1_Click(System::Object^  sender, System::EventArgs^  e) {
			...
			ats11 = Kl4.Mol(Kl4.A, Kl4.n, 18.3, "Li", 0, 0, "", 0);
			ats12 = Kl4.Molsk(ats11) / pow(10, 23);
			mol = Kl4.Mol(Kl4.A, Kl4.n, 0, "", 0, 0, "", 7.014 * pow(10, 23));
			ats2 = Kl4.Molinemase(Kl4.D, Kl4.A, Kl4.n, Kl4.l, mol, "NaOH");
			mol = 0;
			mol = Kl4.Mol(Kl4.A, Kl4.n, 0, "", 0, 0, "", 9.562 * pow(10, 23));
			ats31 = Kl4.Turis(Kl4.A, Kl4.n, mol, "P", 0);
			ats32 = Kl4.Molinemase(0, Kl4.A, Kl4.n, 0, mol, "P");
