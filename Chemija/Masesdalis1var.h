...
namespace Chemija {
	...
	namespace {
		Klase K7; // klasės objektas
	};
	/// <summary>
	/// Summary for Masesdalis1var
	/// </summary>
	public ref class Masesdalis1var : public System::Windows::Forms::Form
	{
	public:
		Masesdalis1var(void)
		{
...
#pragma region Windows Form Designer generated code
		...
		void InitializeComponent(void)
		{
			...
			this->groupBox1->Size = System::Drawing::Size(336, 541);
			...
			this->label13->Location = System::Drawing::Point(214, 488);
			...
			this->label12->Location = System::Drawing::Point(56, 488);
			...
			this->label3->Text = L"Ats. (vandenilio %):";
			// 
			// textBox2
			// 
			...
			this->button1->Click += gcnew System::EventHandler(this, &Masesdalis1var::button1_Click);
			// 
			// textBox8
			// 
			...
			// label6
			// 
			this->label6->Location = System::Drawing::Point(22, 200);
			this->label6->Name = L"label6";
			this->label6->Size = System::Drawing::Size(340, 27);
			this->label6->TabIndex = 5;
			this->label6->Text = L"3. Kuriame junginyje deguonies masės dalis yra mažesnė: sieros diokside (SO₂) ar " 
				L"anglies diokside (CO₂)\?\r\n";
			// 
			// label5
			// 
			...
			this->label4->Location = System::Drawing::Point(26, 119);
			this->label4->Name = L"label4";
			this->label4->Size = System::Drawing::Size(243, 13);
			this->label4->TabIndex = 3;
			this->label4->Text = L"2. Raskite kalio masės dalį kalio hidrokside (KOH).\r\n";
			// 
			// label2
			// 
			...
			this->label2->Text = L"Ats. (anglies %):";
			// 
			// label1
			// 
			...
			this->label1->Text = L"1. Apskaičiuokite anglies ir vandenilio masės dalis metane CH₄.";
			// 
			// menuStrip1
			// 
			...
			this->menuStrip1->Size = System::Drawing::Size(343, 24);
			...
			this->periodinėCheminiųElementųLentelėToolStripMenuItem->Click += gcnew System::EventHandler(this, &Masesdalis1var::periodinėCheminiųElementųLentelėToolStripMenuItem_Click);
			// 
			// Masesdalis1var
			// 
			this->AutoScaleDimensions = System::Drawing::SizeF(6, 13);
			this->AutoScaleMode = System::Windows::Forms::AutoScaleMode::Font;
			this->ClientSize = System::Drawing::Size(343, 557);
			this->Controls->Add(this->menuStrip1);
			this->Controls->Add(this->groupBox1);
			this->Name = L"Masesdalis1var";
			this->StartPosition = System::Windows::Forms::FormStartPosition::CenterScreen;
			this->Text = L"1 variantas";
			this->Load += gcnew System::EventHandler(this, &Masesdalis1var::Masesdalis1var_Load);
...
#pragma endregion
	private: System::Void Masesdalis1var_Load(System::Object^  sender, System::EventArgs^  e) {
				label8->Hide();
				label9->Hide();
				label10->Hide();
				label11->Hide();
	...
	private: System::Void button1_Click(System::Object^  sender, System::EventArgs^  e) {
				 ...
				 K7.Masesdalissk(K7.A, K7.n, "C", 16, w1, w2);
				 ats11 = w1;
				 ats12 = w2;
				 ats2 = K7.Masesdalisjung(K7.A, K7.D, K7.n, K7.l, "KOH", "K");
				 ats2 = Math::Round(ats2, 2);
				 String^ x = gcnew String(ats3.c_str()); 
				 x = "SO2";
				 label8->Show();
				 label9->Show();
				 label10->Show();
